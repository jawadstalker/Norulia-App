    ...
    verses: [
      {
        ...
        translation: 'بگو: اوست خدای یگانه',
      },
      {
        number: 2,
        arabic: 'اللَّهُ الصَّمَدُ',
        translation: 'خداوند بی‌نیاز است',
      },
      {
        number: 3,
        arabic: 'لَمْ يَلِدْ وَلَمْ يُولَدْ',
        translation: 'نه زاده و نه زاده شده است',
      },
      {
        number: 4,
    ...
    verses: [
      {
        ...
        translation: 'بگو: به پروردگار مردم پناه می‌برم',
      },
      {
        number: 2,
      ...
      },
      {
        ...
        translation: 'چه از جن و چه از انسان',
      },
    ],
  },
  {
    ...
    verses: [
      {
        ...
        translation: 'بگو: به پروردگار سپیده‌دم پناه می‌برم',
      },
      {
        number: 2,
      ...
      },
      {
        ...
        translation: 'و از شر تاریکی شب هنگامی که فراگیر شود',
      },
      {
        number: 4,
    ...
    verses: [
      {
        ...
        translation: 'همانا ما به تو کوثر عطا کردیم',
      },
      {
        number: 2,
      ...
      },
      {
        ...
        translation: 'همانا دشمن تو خود بی‌دنباله است',
      },
    ],
  },
];
          ...
          {filteredSurahs.length === 0 ? (
            ...
            filteredSurahs.map((surah, index) => (
              ...
              >
                ...
                >
                  <View style={styles.surahCardTop}>
                    <View
                      style={[
                        styles.surahNumber,
                        {
