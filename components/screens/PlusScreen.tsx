...
export default function QuranScreen() {
  ...
  const screenGradient: [string, string, string] = isDark
    ? ['#241D3A', '#1B1530', '#150F26']
    : ['#F4F0FF', '#FAF9FF', '#FFFFFF'];

  const cardShadow = getShadowStyle(isDark, 0.8);
        ...
        >
          ...
          >
            ...
            <View style={styles.headerCenter}>
              ...
              >
                روز {currentDay} از {PLAN.length} • {progress}٪ تکمیل شده
              </Text>
            </View>
            ...
            >
              ...
              >
                <LinearGradient
                  colors={
                    isDark
                      ? [colors.primaryLight || '#C4B5FD', colors.primary]
