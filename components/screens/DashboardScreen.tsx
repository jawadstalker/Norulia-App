...
function ShineEffect({
  ...
  return (
    <Animated.View
      pointerEvents="none"
      style={[styles.shineContainer, animatedStyle]}
    >
      <LinearGradient
        colors={[
          'transparent',
...
function GlowLayer({ color, opacity = 0.10 }: GlowLayerProps) {
  return (
    <View
      pointerEvents="none"
      style={[styles.glowLayer, { borderColor: color, opacity }]}
    />
  );
}
...
export function DashboardScreen() {
  ...
  const renderMenuCard = (item: (typeof menuItems)[number], index: number) => {
    const IconComponent = item.icon;
    const title = t[item.titleKey as keyof typeof t] || item.titleKey;
    ...
    return (
      <MotiView
        ...
        transition={{ type: 'timing', duration: 380, delay: 320 + index * 70 }}
        style={[
          styles.menuCardWrapper,
          { width: isVerySmallScreen ? '31.2%' : '31.7%' },
        ]}
      >
        <TouchableOpacity
          activeOpacity={0.82}
          ...
          style={[
            styles.menuCard,
            {
              ...
              minHeight: isVerySmallScreen ? 118 : 132,
            },
          ]}
        >
          <ShineEffect
            color={isDark ? '#FFFFFF' : colors.primary}
            delay={1500 + index * 260}
            duration={1750}
            opacity={isDark ? 0.15 : 0.12}
          />

          <GlowLayer color={colors.primary} opacity={isDark ? 0.08 : 0.045} />
          ...
          <View
            style={[
              styles.menuIconContainer,
              {
                ...
                width: isVerySmallScreen ? 43 : 48,
                height: isVerySmallScreen ? 43 : 48,
              },
            ]}
          >
            <IconComponent
              size={isVerySmallScreen ? 21 : 24}
              color={iconColor}
              strokeWidth={1.9}
            />
          </View>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView
        ...
        contentContainerStyle={[
          ...
          { paddingHorizontal: isVerySmallScreen ? 14 : Spacing.lg },
        ]}
        refreshControl={
          <RefreshControl
      ...
      >
            ...
            <View style={styles.characterWrapper}>
              ...
              <Text
                style={[
                  ...
                  {
                    color: isDark ? 'rgba(255,255,255,0.80)' : '#675F7E',
                    textAlign: isRTL ? 'right' : 'left',
                    writingDirection: isRTL ? 'rtl' : 'ltr',
                  },
                ]}
        ...
        >
          ...
          >
            ...
            <GlowLayer color={colors.primary} opacity={isDark ? 0.055 : 0.035} />
            ...
            <View style={styles.progressBarContainer}>
              ...
              >
                <LinearGradient
                  colors={[progressBarColor, progressBarColor]}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
