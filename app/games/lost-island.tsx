...
export default function LostIslandScreen() {
  ...
  const handleLaunchGame = useCallback(async () => {
    ...
    try {
      const launched = await launchLostIsland();
      ...
      if (!launched) {
        Alert.alert(
          isPersian
            ...
            : 'Game Not Installed',
          isPersian
            ? 'بازی جزیره گمشده روی این دستگاه نصب نشده است.'
            : 'Lost Island is not installed on this device.',
          [
            {
