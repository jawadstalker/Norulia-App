...
export default function ConsultationScreen() {
  ...
  const TEXTS = {
    // هدر
    headerTitle: isRTL ? 'مشاوره تخصصی' : 'Expert Consultation',

    // حباب گفتار
    speechHello: isRTL ? 'سلام، من' : 'Hello, I\'m',
    speechName: 'نورولیا', // name stays same
    speechSub: isRTL
      ? 'در این بخش مشاوره تخصصی در انتظار شماست'
      : 'In this section, expert consultation awaits you',

    // کارت
    cardTitle: isRTL ? 'جلسات مشاوره تخصصی' : 'Expert Consultation Sessions',
    cardDesc: isRTL
    ...
    // دکمه
    btnText: isRTL ? 'درخواست مشاوره' : 'Request Consultation',

    // ساعات
    hoursLabel: isRTL ? 'ساعات پاسخگویی:' : 'Support Hours:',
    hoursDays: isRTL ? 'شنبه تا پنجشنبه' : 'Saturday to Thursday',
    hoursTime: '• ۹:۰۰ تا ۱۸:۰۰', // time is same

    // باکس اطلاعات
    infoBadge: isRTL ? 'ویژه کاربران دارای اشتراک فعال' : 'For users with active subscription',
    infoText: isRTL
    ...
    >
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        ...
        >
          ...
          >
            <BackArrow size={23} color={colors.text} strokeWidth={2.4} />
          </TouchableOpacity>
        </MotiView>
        ...
        >
          ...
          >
            ...
            >
              <Text style={[styles.speechLine1, { color: colors.text }]}>
                {TEXTS.speechHello}{' '}
                <Text style={{ color: colors.primary }}>{TEXTS.speechName}</Text>{' '}
                {isRTL ? 'هستم' : ''}
              </Text>
          ...
          >
            ...
            >
              ...
              >
                <Phone size={21} color="#FFFFFF" strokeWidth={2.2} />
                <Text style={styles.requestButtonText}>{TEXTS.btnText}</Text>
                <BackArrow
                  size={19}
            ...
            <View style={styles.hoursRow}>
              ...
              <Text style={[styles.hoursText, { color: colors.textTertiary }]}>
                {TEXTS.hoursLabel}{' '}
                <Text style={{ color: colors.primary }}>{TEXTS.hoursDays}</Text>{' '}
                {TEXTS.hoursTime}
              </Text>
            </View>
            ...
            >
              <ShieldCheck size={17} color={colors.success} strokeWidth={2} />
