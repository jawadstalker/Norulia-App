...
import { Home, Brain, MessageCircle, Calendar, User, Plus, Sparkles } from 'lucide-react-native';
...
const navItems: NavItem[] = [
  { id: 'index', icon: Home, route: '/(tabs)' },
  { id: 'protocol', icon: Brain, route: '/(tabs)/protocol' },
  { id: 'assistant', icon: MessageCircle, route: '/(tabs)/assistant', isCenter: true },
  { id: 'schedule', icon: Calendar, route: '/(tabs)/schedule' },
  { id: 'plus', icon: Plus, route: '/(tabs)/plus' },
            ...
            {!isCenter && (
              ...
              >
                <Text style={[
                  ...
                  {item.id === 'index' ? 'Home' : 
                   item.id === 'protocol' ? 'Brain' :
                   item.id === 'schedule' ? 'Plan' : 
                   item.id === 'plus' ? 'Plus' : 'Profile'}
                </Text>
              </MotiView>
            )}
          </TouchableOpacity>
